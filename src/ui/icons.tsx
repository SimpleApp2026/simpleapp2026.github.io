...
export const ThumbUpIcon = svg(<><path d="M7 22V10l5-8a2 2 0 0 1 3 2l-1 6h5a2 2 0 0 1 2 2.4l-1.6 8A2 2 0 0 1 17.4 22z"/><rect x="2" y="10" width="5" height="12" rx="1"/></>)
export const ThumbDownIcon = svg(<><path d="M17 2v12l-5 8a2 2 0 0 1-3-2l1-6H5a2 2 0 0 1-2-2.4l1.6-8A2 2 0 0 1 6.6 2z"/><rect x="17" y="2" width="5" height="12" rx="1"/></>)
export const CheckIcon = svg(<polyline points="20 6 9 17 4 12"/>)
export const MailboxIcon = svg(<><path d="M3 20v-8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8z"/><path d="M8 7v6"/><path d="M16 20v-8"/><path d="M17 4h4v5"/></>)
