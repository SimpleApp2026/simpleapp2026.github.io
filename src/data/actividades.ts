...
export const ACTIVIDADES: Actividad[] = [
  ...
  { id: 'cine-teatro-falla', categoria: 'cine', grupo: 'Teatro', titulo: 'Concierto conservatorio: Manuel de Falla', lugar: 'Gallo 200, Sarmiento (Abasto)', fecha: 'Viernes 24 de julio, 19:00h' },
  { id: 'cine-brandoni', categoria: 'cine', grupo: 'Cine', titulo: 'Homenaje a Luis Brandoni', lugar: 'Palacio Libertad (Ex CCK)', fecha: 'Viernes 31 de julio, 15:30h', descripcion: 'Un recorrido por sus interpretaciones más icónicas.' },
  ...
  { id: 'ferias-cocina-abierta', categoria: 'ferias', grupo: 'Feria', titulo: 'Cocina Abierta: Viva la patria', lugar: 'Palacio Libertad (Ex CCK)', fecha: 'Sábado 25 de julio, 14 a 20hs' },
  { id: 'ferias-hora-del-te', categoria: 'ferias', grupo: 'Gastronomía', titulo: 'Hora del té y merienda libre', lugar: 'Palacio Paz', fecha: 'Martes 4 de agosto, 16 a 18hs' },
  // Paseos y salidas
  { id: 'paseos-edificios', categoria: 'paseos', grupo: 'Experiencias culturales', titulo: 'Recorrido por edificios emblemáticos', lugar: 'Plaza de Mayo', fecha: 'Viernes 31 de julio, 17:00h', descripcion: 'Conocé la historia detrás de los edificios más emblemáticos de CABA.' },
  { id: 'paseos-el-plata', categoria: 'paseos', grupo: 'Experiencias culturales', titulo: 'Paseo por el teatro El Plata + clase de milonga', lugar: 'Teatro El Plata', fecha: 'Jueves 30 de julio, 15:30h' },
  ...
  // Vida Saludable
  { id: 'salud-bici', categoria: 'salud', grupo: 'Aire Libre', titulo: 'Soltáte: aprendé a andar en Bici', lugar: 'Plaza Clemente', fecha: 'Sábado 1 de agosto, 13hs' },
